<%-- Document : AddProductImei Created on : Jun 14, 2026, 4:50:41 PM Author : huy --%>
            ...
            <body class="bg-background text-on-surface font-body-md min-h-screen">
                <div class="layout">
                    ...
                    <aside class="sidebar">
                        ...
                        <div class="profile">
                            <div style="cursor: pointer; display: flex; align-items: center; gap: 8px;"
                                ...
                                <% model.Users u=(model.Users) session.getAttribute("user"); if (u !=null &&
                                    u.getAvatarUrl() !=null && !u.getAvatarUrl().trim().isEmpty()) { %>
                                    <img src="${pageContext.request.contextPath}/images/<%= u.getAvatarUrl() %>"
                                        alt="Avatar"
                                        style="width: 28px; height: 28px; border-radius: 50%; object-fit: cover; border: 1px solid var(--blue);">
                                    <% } else { %>
                                        <span>♙</span>
                                        <% } %>
                    ...
                    <div class="main">
                        <!-- TopNavBar Component -->
                        <header
                            class="sticky top-0 z-50 bg-surface border-b border-outline-variant flex justify-between items-center px-gutter h-16 w-full">
                        ...
                        <main class="p-gutter flex-1 bg-surface-container-lowest">
                            ...
                            <div class="max-w-5xl">
                                ...
                                <form action="${pageContext.request.contextPath}/staff/imei/add" method="POST"
                                    onsubmit="return validateForm(event)" class="space-y-6">
                                    <input type="hidden" name="ticketId"
                                        value="${not empty ticketId ? ticketId : param.ticketId}">
