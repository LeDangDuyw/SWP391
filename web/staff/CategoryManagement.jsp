...
<body class="bg-background text-on-surface font-body-md min-h-screen flex">
    ...
    <aside class="fixed h-full left-0 top-0 w-64 bg-surface border-r border-outline-variant/20 flex flex-col py-4 z-40">
        ...
        <nav class="flex-1 flex flex-col gap-1 px-2">
            ...
            <!-- Category -->
            <a class="flex items-center px-4 py-3 mx-2 rounded-lg bg-surface-container-low text-primary font-bold border-l-4 border-primary font-label-md text-sm font-medium transition-all" href="${pageContext.request.contextPath}/staff/category">
                <span class="material-symbols-outlined icon-fill mr-3 text-[20px]">category</span> Category
            </a>
