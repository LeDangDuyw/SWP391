...
<div class="flex">
<!-- SideNavBar -->
<aside class="hidden md:flex flex-col h-[calc(100vh-64px)] py-unit w-64 fixed left-0 bg-surface-container-low border-r border-outline-variant">
...
<a class="flex items-center gap-3 px-4 py-3 text-primary font-bold border-r-2 border-primary bg-surface-container-high rounded-lg" href="#">
...
<!-- Main Content Area -->
<main class="flex-1 ml-0 md:ml-64 p-gutter max-w-container-max mx-auto">
<!-- Header Section -->
