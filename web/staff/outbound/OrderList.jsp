                        ...
                        <tbody class="divide-y divide-outline-variant/20">
                            <c:forEach var="order" items="${orders}">
                                <tr class="hover:bg-surface-container-low/50 transition-colors">
                                    <td class="whitespace-nowrap px-6 py-4 text-body-sm font-semibold" style="color: var(--blue);">${order.orderCode}</td>
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4 text-body-sm">
                                        <span style="background: var(--blue-soft, #dbe8ff); color: var(--blue, #0b39d1); padding: 4px 10px; border-radius: 6px; font-size: 12px; font-weight: 600;">${order.orderStatus}</span>
                                    </td>
                                    <td class="whitespace-nowrap px-6 py-4 text-right">
                                        <a href="${pageContext.request.contextPath}/staff/outbound/fulfill?orderId=${order.orderId}"
                                           style="background: var(--blue); color: white; padding: 6px 14px; border-radius: 8px; font-size: 13px; font-weight: 600; display: inline-flex; align-items: center; gap: 6px;">
