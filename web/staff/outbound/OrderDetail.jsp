...
<div class="layout">
    ...
    <aside class="sidebar">
        ...
        <nav>
            ...
            <a class="active" href="${pageContext.request.contextPath}/staff/outbound/list"><span>📦</span>Orders</a>
    ...
    <div class="main">
        ...
        <main class="flex-1 p-gutter bg-surface-container-lowest">
            <!-- Breadcrumbs -->
            <div class="mb-4">
                <a href="${pageContext.request.contextPath}/staff/outbound/list" class="text-body-sm text-on-surface-variant hover:text-primary flex items-center gap-1">
            ...
            <div class="flex justify-between items-end mb-6">
                <div>
                    <h2 class="font-headline-lg text-headline-lg text-on-surface mb-1">Chi tiết đơn hàng #${order.orderCode}</h2>
                    <p class="font-body-sm text-body-sm text-on-surface-variant">Xem chi tiết cấu hình sản phẩm, thông tin người nhận và thực hiện thay đổi trạng thái giao nhận.</p>
                </div>
            </div>
