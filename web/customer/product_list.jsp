            ...
            <div class="product-grid global-search-grid">
                <c:forEach items="${products}" var="p">
                    <div class="product-card">
                        ...
                        <button type="button" onclick="addProductToCompare(${p.productId})" style="width: 100%; border: 1px solid var(--border-color); background: white; color: var(--text-main); font-weight: 500; font-size: 13px; padding: 8px 10px; border-radius: var(--radius-sm); cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 6px; margin-top: 8px; transition: all 0.2s;" onmouseover="this.style.borderColor='var(--primary)'; this.style.color='var(--primary)'" onmouseout="this.style.borderColor='var(--border-color)'; this.style.color='var(--text-main)'">
