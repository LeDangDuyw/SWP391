...
<%
    // Kiểm tra trạng thái chặn của người dùng
    ...
    if (currentUser != null) {
        try {
            ...
            isBlocked = chatbotDAO.isChatbotBlocked(currentUser.getUserId());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    request.setAttribute("isChatbotBlocked", isBlocked);
%>

<c:if test="${not isChatbotBlocked}">
