            ...
            <body>
                ...
                <header class="header">
                    <div class="container header-container">
                                ...
                                <div class="dropdown-content">
                                    <c:forEach items="${categories}" var="cat">
                                        <c:if
                                            ...
                                            <a
                                                href="ProductListServlet?category=${cat.categoryId}">${cat.categoryName}</a>
                                        </c:if>
                                    </c:forEach>
                                </div>
                            </div>
                        ...
                        <div class="header-icons" style="display:flex; align-items:center; gap:15px;">
                            <form action="ProductListServlet" method="GET" class="search-form"
                                style="display:flex; align-items:center; background:#f1f3f9; padding:6px 12px; border-radius:20px;">
                                <input type="text" name="search" placeholder="Tìm kiếm sản phẩm..."
                                    style="border:none; background:transparent; outline:none; font-size:14px; width:180px; font-family:'Inter', sans-serif;">
                                <button type="submit"
                                    style="border:none; background:transparent; cursor:pointer; color:#555;"><i
                ...
                <section class="hero">
                    <div class="hero-slider-wrapper">
                        <div class="hero-slides">
                            <c:forEach items="${banners}" var="b" varStatus="status">
                                <div class="hero-slide ${status.first ? 'active' : ''}">
                                    <a href="#">
                                        <img src="${b.imageUrl}" data-context="${pageContext.request.contextPath}"
                                            class="banner-img-auto" alt="Banner">
                                    </a>
                                </div>
                            </c:forEach>
                            <c:if test="${empty banners}">
                                <div class="hero-slide active">
                                    <a href="#">
                                        <img src="https://images.unsplash.com/photo-1531297122539-5692f6e10821?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80"
                                            alt="Laptop AI">
                                    </a>
                                </div>
                            </c:if>
                        ...
                        <div class="hero-indicators">
                            <c:forEach items="${banners}" var="b" varStatus="status">
                                <span class="hero-dot ${status.first ? 'active' : ''}"
                        ...
                        <div class="container">
                            <div class="section-header flash-sale-header">
                                ...
                                <div class="countdown" id="flash-sale-countdown"
                                    data-endtime="${not empty flashsale ? flashsale[0].endTime.time : ''}">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="product-price">
                                                ...
                                                <span class="current-price">
                                                    <fmt:formatNumber value="${p.salePrice}" pattern="#,##0" />₫
                                                </span>
                                            ...
                                            <div class="actions">
                                                <button type="button" class="btn-add-cart"><i
                                                        class="fas fa-shopping-cart"></i> Giỏ hàng</button>
                ...
                <section class="best-sellers">
                    <div class="container">
                        ...
                        <div class="tabs">
                            <a href="HomeServlet?bsTab=laptop&newTab=${newTab}"
                                class="tab-btn ${bsTab == 'laptop' || empty bsTab ? 'active' : ''}">Laptop</a>
                            <a href="HomeServlet?bsTab=chuot&newTab=${newTab}"
                                class="tab-btn ${bsTab == 'chuot' ? 'active' : ''}">Chuột</a>
                            <a href="HomeServlet?bsTab=banphim&newTab=${newTab}"
                                class="tab-btn ${bsTab == 'banphim' ? 'active' : ''}">Bàn phím</a>
                        </div>
                            ...
                            <c:forEach items="${products}" var="p">
                                <div class="product-card">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-price">
                                            <span class="current-price">
                                                <fmt:formatNumber value="${p.minPrice}" type="number"
                                                    pattern="###,###" />₫
                                            </span>
                                            <c:if test="${p.discountPercent > 0}">
                                                <span class="old-price">
                ...
                <section class="new-products" style="padding: 60px 0; background-color: var(--bg-white);">
                    <div class="container">
                        ...
                        <!--hiển thị lựa chọn xem tất cả sản phẩm của danh mục và nhận giá trị danh mục-->
                        <div class="tabs">
                            <a href="HomeServlet?bsTab=${bsTab}&newTab=laptop"
                                class="tab-btn ${newTab == 'laptop' ? 'active' : ''}">Laptop</a>
                            <a href="HomeServlet?bsTab=${bsTab}&newTab=chuot"
                                class="tab-btn ${newTab == 'chuot' ? 'active' : ''}">Chuột</a>
                            <a href="HomeServlet?bsTab=${bsTab}&newTab=banphim"
                                class="tab-btn ${newTab == 'banphim' ? 'active' : ''}">Bàn phím</a>
                        </div>
                    ...
                    <footer class="footer">
                        <div class="container footer-grid">
                            ...
                            <div class="footer-col">
                                ...
                                <p class="footer-brand-desc">Nền tảng mua sắm công nghệ cao cấp hàng đầu. Chúng tôi cam
                                    kết đem lại trải nghiệm mua sắm tuyệt vời nhất với các sản phẩm laptop, bàn phím và
                                    chuột máy tính chính hãng chất lượng cao.</p>
                    ...
                    <div class="chat-widget-container">
                        <div class="chat-widget-header">
                            <div class="chat-header-info">
                                ...
                                <div class="chat-header-title">
                                    <h3>UniLap AI Advisor</h3>
                                    <div class="chat-header-status">
                                        <span class="chat-status-dot"></span> Đang hoạt động
                                    </div>
                                </div>
                            </div>
                            <div class="chat-header-actions">
                                <button class="chat-action-btn chat-expand-btn" title="Mở rộng toàn trang">
                                    <i class="fas fa-expand-alt"></i>
                                </button>
                                <button class="chat-action-btn chat-close-btn" title="Thu nhỏ">
                        ...
                        <div class="chat-quick-replies">
                            <button class="quick-reply-btn"
                                data-question="Cửa hàng có những loại laptop nào vậy?">Laptop</button>
                            <button class="quick-reply-btn" data-question="Tư vấn giúp mình chuột chơi game tốt">Chuột
                                Gaming</button>
                            <button class="quick-reply-btn" data-question="Chính sách đổi trả sản phẩm thế nào?">Chính
                                sách</button>
                        </div>

                        <div class="chat-input-area">
                            <input type="text" class="chat-input-field" placeholder="Hỏi UniLap AI..."
                                autocomplete="off">
