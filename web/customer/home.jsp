    ...
    <body>
        ...
        <div class="chat-widget-container">
            ...
            <div class="chat-quick-replies">
                <button class="quick-reply-btn" data-question="Cửa hàng có những loại laptop nào vậy?">Laptop</button>
                <button class="quick-reply-btn" data-question="Tư vấn giúp mình chuột chơi game tốt">Chuột Gaming</button>
                <button class="quick-reply-btn" data-question="Chính sách đổi trả sản phẩm thế nào?">Chính sách</button>
            </div>

            <div class="chat-input-area">
                <input type="text" class="chat-input-field" placeholder="Hỏi UniLap AI..." autocomplete="off">
