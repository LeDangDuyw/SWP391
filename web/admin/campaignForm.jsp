                ...
                <%@ page import="java.util.Locale" %>
                    <%@ page import="model.Campaign" %>
                        <%@ page import="model.ProductSearchItem" %>
                            ...
                            <%! String h(String s) { if (s==null) { return "" ; } return s.replace("&", "&amp;" )
                                .replace("<", "&lt;" ) .replace(">", "&gt;")
                                .replace("\"", "&quot;");
                                }
                                ...
                                %>
                                <% String base=request.getContextPath() + "/admin/campaign-form" ; String
                                    listBase=request.getContextPath() + "/admin/promotions" ; Campaign c=(Campaign)
                                    request.getAttribute("campaign"); boolean editing=false; if (c !=null &&
                                    c.getCampaignId()> 0) {
                                    editing = true;
                                    }
                                    ...
                                    List<ProductSearchItem> products = (List<ProductSearchItem>)
                                            ...
                                            products = new ArrayList<ProductSearchItem>();
                                                ...
                                                <head>
                                                    ...
                                                    <link rel="stylesheet"
                                                        href="<%= request.getContextPath() %>/css/promotion.css">
                                                </head>
                                                ...
                                                <body>
                                                    <div class="layout">
                                                        ...
                                                        <aside class="sidebar">
                                                            <div class="brand"><span>UNILAP Admin</span><small>System
                                                                    Controller</small></div>
                                                            <nav>
                                                                <a href="AdminDashboard.jsp"><span>▦</span>Dashboard</a>
                                                                <a href="#"><span>▣</span>Orders</a>
                                                                <a href="#"><span>♚</span>Users</a>
                                                                <a class="active"
                                                                    href="<%=listBase%>"><span>▥</span>Analytics</a>
                                                                <a
                                                                    href="<%=request.getContextPath()%>/admin/policy"><span>📜</span>Policies</a>
                                                                                ...
                                                                                <div>
                                                                                    ...
                                                                                    <select name="campaignType"
                                                                                        ...
                                                                                        <option value="percentage"
                                                                                            <%=selected(c.getCampaignType(), "percentage"
                                                                                            ) %>>
                                                                                            Percentage Discount
                                                                                        </option>
                                                                                        <option value="fixed"
                                                                                            <%=selected(c.getCampaignType(), "fixed"
                                                                                            ) %>>
                                                                                            Fixed Amount Discount
                                                                                        </option>
                                                                                        <option value="flash"
                                                                                            <%=selected(c.getCampaignType(), "flash"
                                                                                            ) %>>
                                                                                            Flash Sale / Auto Apply
                                                                                        </option>
                                                                                        <option value="bundle_discount"
                                                                                            <%=selected(c.getCampaignType(), "bundle_discount"
                                                                                            ) %>>
                                                                                            Buy Together Discount
                                                                                        </option>
                                                                                        <option
                                                                                            value="gift_with_purchase"
                                                                                            <%=selected(c.getCampaignType(), "gift_with_purchase"
                                                                                            ) %>>
                                                                                            Gift With Purchase
                                                                                        </option>
                                                                                    </select>
                                                                                ...
                                                                                <div>
                                                                                    ...
                                                                                    <select name="targetGroup">
                                                                                        <option value="All Customers"
                                                                                            <%=selected(c.getTargetGroup(), "All Customers"
                                                                                            ) %>>
                                                                                            All Customers
                                                                                        </option>
                                                                                        <option value="New Customers"
                                                                                            <%=selected(c.getTargetGroup(), "New Customers"
                                                                                            ) %>>
                                                                                            New Customers
                                                                                        </option>
                                                                                        <option value="Students"
                                                                                            <%=selected(c.getTargetGroup(), "Students"
                                                                                            ) %>>
                                                                                            Students
                                                                                        </option>
                                                                                        <option value="B2B Customers"
                                                                                            <%=selected(c.getTargetGroup(), "B2B Customers"
                                                                                            ) %>>
                                                                                            B2B Customers
                                                                                        </option>
                                                                                    </select>
                                                     ...
                                                     <% 
                                                         boolean isPerc = "percentage".equals(c.getCampaignType()) || c.getCampaignType() == null; 
                                                         String initialStep = isPerc ? "1" : "100000";
                                                         String initialMin = isPerc ? "0.1" : "100000";
                                                     %>
                                                     <div class="input-group">
                                                         <input name="discountValue"
                                                             id="discountValue"
                                                             type="number" step="<%= initialStep %>"
                                                             min="<%= initialMin %>"
                                                             value="<%= numberValue(c.getDiscountValue()) %>">
                                                         <span class="input-suffix"
                                                             id="discountUnit">VND</span>
                                                     </div>
                                                 </div>
                                                                        ...
                                                                        <section class="form-card product-picker">
                                                                            <div class="inline-title">
                                                                                ...
                                                                                <small>Chọn trực tiếp sản phẩm/variant
                                                                                    trong database.</small>
                                                                            </div>

                                                                            <input type="search" id="productFilter"
                                                                            ...
                                                                            <div class="product-list" id="productList">
                                                                                ...
                                                                                <% for (int i=0; i < products.size();
                                                                                    i++) { ProductSearchItem
                                                                                    p=products.get(i); String
                                                                                    searchText=String.valueOf(p.getProductName())
                                                                                    + " " +
                                                                    ...
                                                                    <aside class="right-stack">
                                                                        ...
                                                                        <section class="form-card side-card">
                                                                            ...
                                                                            <div class="info-box">
                                                                                ⓘ This campaign will automatically
                                                                                activate at 12:00 AM on the start date.
                                                                            </div>
                                                                        </section>
                                                                        ...
                                                                        <section class="form-card side-card">
                                                                            ...
                                                                            <select name="status">
                                                                                <option value="scheduled"
                                                                                    <%=selected(c.getStatus(), "scheduled"
                                                                                    ) %>>
                                                                                    Scheduled
                                                                                </option>
                                                                                <option value="active"
                                                                                    <%=selected(c.getStatus(), "active"
                                                                                    ) %>>
                                                                                    Active
                                                                                </option>
                                                                                <option value="paused"
                                                                                    <%=selected(c.getStatus(), "paused"
                                                                                    ) %>>
                                                                                    Paused
                                                                                </option>
                                                                                <option value="pending_approval"
                                                                                    <%=selected(c.getStatus(), "pending_approval"
                                                                                    ) %>>
                                                                                    Pending Approval
                                                                                </option>
                                                                                <option value="stopped"
                                                                                    <%=selected(c.getStatus(), "stopped"
                                                                                    ) %>>
                                                                                    Stopped
                                                                                </option>
                                                                            </select>
                                                    ...
                                                    <script>
                                                        ...
                                                        var campaignType = document.getElementById("campaignType");
                                                        ...
                                                        function updateDiscountUnit() {
                                                            if (campaignType) {
                                                                var isPercentage = campaignType.value === "percentage";
                                                                if (discountUnit) {
                                                                    discountUnit.textContent = isPercentage ? "%" : "VND";
                                                                }
                                                                if (discountValue) {
                                                                    if (isPercentage) {
                                                                        discountValue.setAttribute("step", "1");
                                                                        discountValue.setAttribute("min", "0.1");
                                                                    } else {
                                                                        discountValue.setAttribute("step", "100000");
                                                                        discountValue.setAttribute("min", "100000");
                                                                        
                                                                        // Also adjust user input if they switched from percentage to value and value is too small
                                                                        if (discountValue.value && parseFloat(discountValue.value) < 100000) {
                                                                            discountValue.value = "100000";
                                                                        }
                                                                    }
                                                                }
                                                            }
                                                        ...
                                                        if (campaignType) {
                                                            campaignType.addEventListener("change", updateDiscountUnit);
                                                            updateDiscountUnit();
                                                        }
                                                    </script>
