...
/**
 * Class CampaignStats đại diện cho số liệu thống kê tổng quan của các chiến
 * dịch trên Dashboard. Bao gồm các thông số đếm số lượng chiến dịch theo trạng
 * thái và tổng số lượt sử dụng voucher. Tác nhân liên quan: Admin xem số liệu
 * tổng quan.
 */
