...
public class LoginGoogleController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                java.util.List<model.CartItem> sessionCart = (java.util.List<model.CartItem>) session.getAttribute("cart");
                ...
                // Load combined cart from DB
                session.setAttribute("cart", cartDAO.getCart(user.getUserId()));
            } catch (Exception e) {
                System.out.println("LoginGoogleController Cart Sync Error: " + e.getMessage());
                e.printStackTrace();
            }
